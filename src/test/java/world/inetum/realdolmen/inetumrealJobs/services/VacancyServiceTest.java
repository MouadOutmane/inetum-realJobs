...
public class VacancyServiceTest {
    ...
    public void givenVacancyRepository_whenSaveAndRetreiveEntity_Success() {
        ...
        Vacancy assertEntity = foundEntity.get();
        assertAll(
                () -> assertEquals(addedVacancy.getCity(), assertEntity.getCity()),
                () -> assertEquals(addedVacancy.getIndustry(), assertEntity.getIndustry()),
                () -> assertEquals(addedVacancy.getContractType(), assertEntity.getContractType()),
                () -> assertEquals(addedVacancy.getCompanyName(), assertEntity.getCompanyName())
        );
    }
